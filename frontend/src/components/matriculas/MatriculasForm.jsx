            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                    ...
                    <div className="flex justify-between items-center mt-8 pt-5 border-t border-gray-200">
                        ...
                        <div className="flex items-center gap-3"> {/* <-- Agregamos items-center aquí */}
                            <button
                                type="submit"
                                disabled={loading}
                                className="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition flex items-center shadow-md disabled:opacity-75"
                            >
                                {loading ? (
                            ...
                            <button
                                ...
                                onClick={resetForm}
                                disabled={loading}
                                className="bg-red-500 text-white px-5 py-2 rounded-lg hover:bg-red-600 transition flex items-center shadow-md disabled:opacity-75"
                            >
                                Cancelar
                            </button>
                        </div>
